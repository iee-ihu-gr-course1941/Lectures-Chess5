 ...
 * Κάντε clone το project σε κάποιον φάκελο <br/>
  `$ git clone https://github.com/iee-ihu-gr-course1941/ADISE19_GMCHESS`

 * Βεβαιωθείτε ότι ο φάκελος είναι προσβάσιμος από τον Apache Server. πιθανόν να χρειαστεί να καθορίσετε τις παρακάτω ρυθμίσεις.

 * Θα πρέπει να δημιουργήσετε στην Mysql την βάση με όνομα 'login' και να φορτώσετε σε αυτήν την βάση τα δεδομένα από το αρχείο DB/schema5.sql
...
Ο ναρκαληευτης παιζεται ως εξής: Πατοντας καθε κενο εικονιδιο εμφανιζεται ενα αλλο εικονιδιο το οποιο παριστανετε ειτε με βομβα ειτε με αριθμους.

Οι κανόνες είναι οι καθε εικονιδιο δειχνει τον αριθμο τον βομβων γυρο απο αυτο .Δεν πρεπει να πετυχεις το εικονιδιο βομβα αλλιως εχασες.Για να κερδισεις το παιχνιδι πρεπει να εμφανιστουν ολα τα εικονιδια του ταμπλο επιτυχως χωρις να εχεις ανοιξει βομβα τοτε αυτοματος κερδιζεις το παιχνιδι.

Η βάση μας κρατάει τους εξής πίνακες και στοιχεία :'username', 'email', 'user_type', 'password'

Η εφαρμογή αναπτύχθηκε μέχρι το σημείο ολο 
